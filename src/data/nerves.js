...
export const nerves = [
...

  {
    ...
    landmarks: ["axilla_left", "elbow_left", "wrist_left", "hand_left"],
    plexus: "brachial",
    category: "logic",
    signal: "mixed",
    pulseSpeed: 1.1,
  ...
  },
  {
    ...
    side: "right",
    spinalLevels: ["C6", "C7", "C8", "T1"],
    landmarks: ["axilla_right", "elbow_right", "wrist_right", "hand_right"],
    plexus: "brachial",
    category: "logic",
    signal: "mixed",
    pulseSpeed: 1.1,
...

  {
    ...
    landmarks: ["shoulder_left", "elbow_left", "wrist_left", "hand_left"],
    plexus: "brachial",
    category: "logic",
    signal: "mixed",
    pulseSpeed: 1.0,
  ...
  },
  {
    ...
    side: "right",
    spinalLevels: ["C5", "C6", "C7", "C8"],
    landmarks: ["shoulder_right", "elbow_right", "wrist_right", "hand_right"],
    plexus: "brachial",
    category: "logic",
    signal: "mixed",
    pulseSpeed: 1.0,
...

  {
    ...
    side: "left",
    spinalLevels: ["L4", "L5", "S1", "S2", "S3"],
    landmarks: ["knee_left", "calf_left", "ankle_left", "foot_left"],
  ...
  },
  {
    ...
    side: "right",
    spinalLevels: ["L4", "L5", "S1", "S2", "S3"],
    landmarks: ["knee_right", "calf_right", "ankle_right", "foot_right"],
    plexus: null,
    category: "logic",
    signal: "mixed",
    pulseSpeed: 1.0,
...

  {
    ...
    side: "left",
    spinalLevels: ["L4", "L5", "S1", "S2"],
    landmarks: ["knee_left", "ankle_left", "foot_left"],
    plexus: null,
    category: "logic",
    signal: "mixed",
    pulseSpeed: 0.9,
  ...
  },
  {
    ...
    side: "right",
    spinalLevels: ["L4", "L5", "S1", "S2"],
    landmarks: ["knee_right", "ankle_right", "foot_right"],
    plexus: null,
    category: "logic",
    signal: "mixed",
    pulseSpeed: 0.9,
