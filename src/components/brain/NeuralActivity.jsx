...
const BASE_SPARKS = [
  ...
  { pathIndex: 11, speed: 0.35, phase: 0.3, color: new THREE.Color("#ffff00") },
  ...
  { pathIndex: 17, speed: 0.33, phase: 0.3, color: new THREE.Color("#ffaa44") },
