...
const SPARKS = [
  ...
  { pathIndex: 1, speed: 0.26, phase: 0.6, color: new THREE.Color("#ff00ff") },
  ...
  { pathIndex: 4, speed: 0.42, phase: 0.0, color: new THREE.Color("#00ffff") },
  { pathIndex: 4, speed: 0.42, phase: 0.5, color: new THREE.Color("#ffee00") },
  { pathIndex: 5, speed: 0.22, phase: 0.15, color: new THREE.Color("#ff00ff") },
